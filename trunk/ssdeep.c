/* Generated by Pyrex 0.9.2.1 on Tue Apr 20 15:05:33 2010 */
...
/* Declarations from ssdeep */

staticforward PyTypeObject __pyx_type_6ssdeep_ssdeep;

struct __pyx_obj_6ssdeep_ssdeep {
  PyObject_HEAD
};

static PyTypeObject *__pyx_ptype_6ssdeep_ssdeep = 0;

/* Implementation of ssdeep */


static PyObject *__pyx_n_SsdeepException;
static PyObject *__pyx_n_Exception;

static int __pyx_f_6ssdeep_6ssdeep___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_f_6ssdeep_6ssdeep___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_r;
  static char *__pyx_argnames[] = {0};
  if (!PyArg_ParseTupleAndKeywords(__pyx_args, __pyx_kwds, "", __pyx_argnames)) return -1;
  Py_INCREF(__pyx_v_self);

  /* "/home/jose/tmp/ssdeep-2.2/pyssdeep-read-only/ssdeep.pyx":26 */

  __pyx_r = 0;
  goto __pyx_L0;
  __pyx_L1:;
  __Pyx_AddTraceback("ssdeep.ssdeep.__init__");
  __pyx_r = -1;
  __pyx_L0:;
...
static PyObject *__pyx_f_6ssdeep_6ssdeep_hash_file(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6ssdeep_6ssdeep_hash_file[] = "hash_file(self, filename)\n\n        compute the ssdeep fuzzy hash for the input filename. \n        returns a string with the hash value";
...
static PyObject *__pyx_f_6ssdeep_6ssdeep_hash_bytes(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6ssdeep_6ssdeep_hash_bytes[] = "compute the ssdeep fuzzy hash for the data in the buffer";
...
static PyObject *__pyx_f_6ssdeep_6ssdeep_compare(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_6ssdeep_6ssdeep_compare[] = "compare(self, hash1, hash2)\n\n        compare two ssdeep hashes to discover their similarities\n        returns an integer 1-100 on the strength of the match. 0 means no match";
